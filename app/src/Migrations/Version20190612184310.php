 ...
 */
final class Version20190612184310 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE articles_list (article_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_1E343F5F7294869C (article_id), INDEX IDX_1E343F5FBAD26311 (tag_id), PRIMARY KEY(article_id, tag_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
